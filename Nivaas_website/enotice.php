<?php
	...
	if($type=='status'){
		...
		$update_status_sql = "update emergency_notice set status='$status' where id='$id'";
...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='delete'){
		$id = get_safe_value($con,$_GET['id']);
		$delete_sql = "delete from emergency_notice where id='$id'";
                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
						   ...
						   <h4 class="box-link"><a href='manage_enotice.php'>Add emergency Notice<a></h4>
                        </div>
                        <div class="card-body--">
									 ...
									 while($row=mysqli_fetch_assoc($res)) {?>
										<tr>
										   ...
										   <?php									
												...
												echo "<span class='badge badge-edit'><a href='manage_enotice.php?id=".$row['id']."'>Edit</a></span>&nbsp";
