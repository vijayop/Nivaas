            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                 ...
                 <li class="menu-item-has-children dropdown">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="common_plot_booking.php" > common plot booking</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="application.php" > application to open your own shop</a>
                  </li>
				   <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand hidden" href="notice.php"><img src="images/logo.png" alt="logo"></a>
