...
if (isset($_POST['submit'])){
	...
	$res=mysqli_query($con,"Select * from notice where text='$notice_text'");
	$check = mysqli_num_rows($res);
	if($check>0){
		...
		if(isset($_GET['id']) && $_GET['id']!=''){
			mysqli_query($con,"update notice set text='$notice_text' where id = '$id'");
		}
		else{
			mysqli_query($con,"insert into notice(text,status) values('$notice_text',1)");
		}
		header('location:notice.php');
		die();
	}
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Notice</strong><small> Form</small></div>
                        <form method="post">
